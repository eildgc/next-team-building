    ...
    <main class="w-full flex flex-col gap-4 md:gap-20 mx-auto px-20 py-8">
      <div class="flex justify-center items-center flex-col md:flex-row gap-4 md:gap-14 mt-14 md:mt-0">
        ...
        <Card>
          ...
          <Button
            href="./room.html"
            classes={"w-full md:w-1/2 p-1 mx-auto rounded-lg border-b border-sky-800 bg-gradient-to-r from-sky-900 to-sky-500 hover:bg-gradient-to-l text-center text-gray-100 py-4 text-sm md:text-base"}
          >
