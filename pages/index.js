      ...
      <main class="w-full flex flex-col gap-4 md:gap-36 mx-auto px-20 py-8">
        <div class="flex justify-center items-center flex-col md:flex-row gap-4 md:gap-14 mt-14 md:mt-6">
          ...
          >
            ...
            <p class="text-center">
              Nuestra herramienta única fortalece la cohesión del equipo al
              crear un ambiente de confianza donde se fomenta la comunicación y
              la conexión, permitiendo que todos compartan sus experiencias y
              pensamientos.
            </p>
          </div>
          <CreateRoom />
        ...
        <div class="w-full h-full flex flex-col md:flex-row gap-4 justify-center content-center text-sky-50 mt-0 md:mt-6">
          <div class="w-full md:w-2/6 flex flex-col gap-2 rounded-lg bg-sky-950 p-8 border border-sky-900">
            ...
            <h3 class="font-bold text-lg">Conversaciones significativas</h3>
            <p class="text-sm md:text-md">
              ...
              estimulantes, nuestra herramienta te ayudará a construir
              conexiones más fuertes dentro de tu equipo.
            </p>
          </div>
          <div class="w-full md:w-2/6 flex flex-col gap-2 rounded-lg bg-sky-950 p-8 border border-sky-900">
            <svg class="text-sky-50 fill-current w-14 h-14" viewBox="0 0 24 24">
            ...
            <h3 class="font-bold text-lg">Habla y comparte</h3>
            <p class="text-sm md:text-md">
              Habla y comparte tus respuestas con tu equipo usando tu aplicación
              de voz favorita. Rompe las barreras de la comunicación y fomenta
              la colaboración de una manera fácil y conveniente.
            </p>
          </div>
          <div class="w-full md:w-2/6 flex flex-col gap-2 rounded-lg bg-sky-950 p-8 border border-sky-900">
            <svg class="text-sky-50 fill-current w-14 h-14" viewBox="0 0 24 24">
            ...
            <h3 class="font-bold text-lg">Personaliza tu experiencia</h3>
            <p class="text-sm md:text-md">
              Personaliza tu experiencia de team building con nuestra amplia
              gama de tarjetas y categorías. Desde actividades divertidas hasta
              reflexiones serias, hay algo para cada equipo. ¡Haz que cada
              sesión sea única y memorable!
            </p>
          </div>
        </div>
      </main>
