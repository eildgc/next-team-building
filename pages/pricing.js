...
export default function Pricing() {
  return (
    <LayoutDesk>
      <div className="w-full md:w-2/6 flex flex-col gap-4 items-center justify-between bg-sky-500 border border-sky-900 rounded-lg p-8 mx-auto">
        <h2 className="text-lg font-bold self-start mt-4">APOYO AL PROYECTO</h2>
        <Button
          className={
