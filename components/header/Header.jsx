export default function Header() {
  return (
    <header class="w-full h-12 flex items-center text-sky-100 font-bold px-4 py-6">
      <a class="w-1/2 h-1/2 md:w-full md:h-full" href="./index.html">
        <svg class="w-8 md:w-14 h-8 md:h-14" fill="none">
          <path
            fill="#D9D9D9"
            stroke="#2B599B"
            stroke-width="4"
      ...
      <ul class="w-full flex gap-4 md:gap-10 items-center justify-center md:justify-end text-sm">
        <li class="w-18">
          <a
            class="hover:underline hover:decoration-sky-300 py-4"
            href="./index.html"
          >
            Inicio
          </a>
        ...
        <li class="w-18">
          <a
            class="w-6 h-6 hover:underline hover:decoration-sky-950"
            href="https://github.com/eildgc/team-building"
            target="_blank"
          >
            <svg
              class="animate-bounce text-sky-50 hover:text-slate-600 hover:animate-none ease-in-out fill-current h-6 w-6"
              viewBox="0 0 24 24"
            >
